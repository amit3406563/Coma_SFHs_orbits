...
incorr_sfr = pd.read_csv('steckmap_sfr.csv')
corr_sfr = pd.read_csv('corr_sfr.csv')

gmp_names = ['3254','3269', '3291', '3352', '3367', '3414',
             '3534', '3565', '3639', '3664']
...
plt.savefig('sfr_incor.pdf',dpi=500)
...
plt.savefig('sfr_corr.pdf',dpi=500)
